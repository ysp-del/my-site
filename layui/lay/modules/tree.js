...
layui.define("jquery", function (e) {
    ...
        }, r.prototype.tree = function (e, a) {
        ...
                layui.each(n, function (a, n) {
                        var l = n.children && n.children.length > 0,
                ...
                                    }(), function () {
                                        return '<a href="' + (n.href || "javascript:;") + '" ' + (r.target && n.href ? 'target="' + r.target + '"' : "") + ">" + ('' + (l ? '' : '<i class="layui-icon layui-tree-chain"></i>') + '<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ?  n.spread ? t.branch[1] : t.branch[0] : t.leaf) + "</i>") + ("<cite>" + (n.name || "未命名") + "</cite></a>")
                                    }(), "</li>"].join(""));
    ...
        }, r.prototype.click = function (e, o) {
        ...
                e.children("a").on("click", function (e) {
                    $('ul').children('li').children('a').find('cite').removeClass('citecolor');
                    $(e.currentTarget).children('cite').addClass('citecolor');
        ...
                var a = this,
            ...
                        l = function () {
                                e.data("spread") ? (e.data("spread", null), r.removeClass("layui-show"), i.html(t.arrow[0]), n.find(
                                        ".layui-icon").html(t.branch[0])) : (e.data("spread", !0), r.addClass("layui-show"), i.html(t.arrow[
                                            1]), n.find(".layui-icon").html(t.branch[1]))
                        };
